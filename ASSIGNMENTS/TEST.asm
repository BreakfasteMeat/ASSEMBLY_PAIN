...
MAIN PROC
    ...
    mov DX,offset inputString1 + 2   ; Skip the first two bytes (length and max length)
    MOV AH, 09h               ; DOS function to display a string
    INT 21h
    ...
    mov DX,offset inputString2 + 2   ; Skip the first two bytes (length and max length)
    MOV AH, 09h               ; DOS function to display a string
    INT 21h
    ...
    mov DX,offset inputString3 + 2   ; Skip the first two bytes (length and max length)
    MOV AH, 09h               ; DOS function to display a string
    INT 21h
