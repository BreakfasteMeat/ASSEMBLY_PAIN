...
; Description: This assembly language program will get 2 integer inputs and displays their product
.model small
.stack 500h
.data
    max_len equ 10
    input db 6 dup('$')
    input2 db 6 dup('$')
    head db 'MULTIPLICATION',13,10,'$'    
    prompt db 13,10,'Input Multiplicand: $'
    prompt2 db 'Input Multiplier: $'
    prompt_result db 13,10,'Product: $'
