...
; Program Description: print the hex equivalent of ASCII character code.
...
initial_message db 'Filename: Prog35.asm',13,10,'Programmer Name: SETH NATHANIEL G. EMIA',13,10,'Program Description: print the hex equivalent of ASCII character code.',13,10,'Date Created: November 8, 2024',13,10,10
